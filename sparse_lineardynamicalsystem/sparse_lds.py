...
# Store data in a format readable by julia
np.savetxt("sparse_lds_x.txt", xs.T)
np.savetxt("sparse_lds_u.txt", us.T)
np.savetxt("sparse_lds_A.txt", A)
np.savetxt("sparse_lds_B.txt", B)
np.savetxt("sparse_lds_W.txt", W)
